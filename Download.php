...
class Download extends Command {
    ...
    private function getSubtitlesFromHtml($html) {
        ...
        // get download link of each sub
        $allSubsInPage->filterXPath('//*[@id="buscador_detalle_sub_datos"]/a[last()]')->each(function ($node, $i) use (&$subs) {
    ...
    private function download($subtitle) {
        ...
        $tmpPath = getcwd();
        $res = $this->client->get($subtitle['link'], ['save_to' => $tmpPath . '/' . $filename]);
